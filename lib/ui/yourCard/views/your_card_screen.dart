  ...
  _itemCardView(int index, BuildContext context,YourCardsController logic) {
    return Material(
      ...
      child: InkWell(
        ...
        onTap: () {
          Get.toNamed(AppRoutes.addKankotri,arguments: [true,logic.allYourCardList[index],Constant.isFromUpdate,Constant.isFromMyCardsScreen])!.then((value) => logic.getAllYourCardsAPI(context));
        },
        child: ClipRRect(
